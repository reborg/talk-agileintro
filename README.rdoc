...
This is my talk on Agile processes introduction including slides, exercises, outlines and all supporting files. I will fork a branch for each re-incarnation of the same talk for different events.
